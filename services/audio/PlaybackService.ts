...
module.exports = async function () {
  ...
  TrackPlayer.addEventListener(Event.RemotePlay, async () => {
    ...
    console.log('[PlaybackService] Platform:', Platform.OS);
    console.log('[PlaybackService] Timestamp:', new Date().toISOString());
    console.log('[PlaybackService] About to call TrackPlayer.play()');
    try {
      await TrackPlayer.play();
      console.log('[PlaybackService] TrackPlayer.play() completed successfully');
    } catch (error) {
      console.error('[PlaybackService] Failed to play:', error);
    }
    console.log('[PlaybackService] ========== Remote play event handler finished ==========');
  });
  ...
  TrackPlayer.addEventListener(Event.RemotePause, async () => {
    ...
    console.log('[PlaybackService] Platform:', Platform.OS);
    console.log('[PlaybackService] Timestamp:', new Date().toISOString());
    console.log('[PlaybackService] About to call TrackPlayer.pause()');
    try {
      await TrackPlayer.pause();
      console.log('[PlaybackService] TrackPlayer.pause() completed successfully');
    } catch (error) {
      console.error('[PlaybackService] Failed to pause:', error);
    }
    console.log('[PlaybackService] ========== Remote pause event handler finished ==========');
  });
   ...
   * @param event - Contains paused and permanent flags
   */
