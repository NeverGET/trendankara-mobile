# gcp-proxy-gateway - Task 7

Execute task 7 for the gcp-proxy-gateway specification.

## Task Description
Create .gcloudignore for deployment optimization
...
## Usage
```
/Task:7-gcp-proxy-gateway
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create .gcloudignore for deployment optimization"

```
Use the @spec-task-executor agent to implement task 7: "Create .gcloudignore for deployment optimization" for the gcp-proxy-gateway specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Create .gcloudignore for deployment optimization
- Requirements: 3.1

## Instructions
- Implement ONLY task 7: "Create .gcloudignore for deployment optimization"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks gcp-proxy-gateway 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks gcp-proxy-gateway 7 --mode complete
```
