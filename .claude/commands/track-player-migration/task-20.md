# track-player-migration - Task 20

Execute task 20 for the track-player-migration specification.

## Task Description
Update metadata handling in RadioPlayerControls

## Code Reuse
**Leverage existing code**: components/radio/RadioPlayerControls.tsx, hooks/useNowPlaying.ts
...
## Usage
```
/Task:20-track-player-migration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Update metadata handling in RadioPlayerControls"

```
Use the @spec-task-executor agent to implement task 20: "Update metadata handling in RadioPlayerControls" for the track-player-migration specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Update metadata handling in RadioPlayerControls
- Leverage: components/radio/RadioPlayerControls.tsx, hooks/useNowPlaying.ts
- Requirements: 4.1, 7.4

## Instructions
- Implement ONLY task 20: "Update metadata handling in RadioPlayerControls"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks track-player-migration 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks track-player-migration 20 --mode complete
```
