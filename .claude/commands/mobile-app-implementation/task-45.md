# mobile-app-implementation - Task 45

Execute task 45 for the mobile-app-implementation specification.

## Task Description
Create ErrorScreen component in components/common/ErrorScreen.tsx
...
## Usage
```
/Task:45-mobile-app-implementation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create ErrorScreen component in components/common/ErrorScreen.tsx"

```
Use the @spec-task-executor agent to implement task 45: "Create ErrorScreen component in components/common/ErrorScreen.tsx" for the mobile-app-implementation specification and include all the below context.
...
## Task Details
- Task ID: 45
- Description: Create ErrorScreen component in components/common/ErrorScreen.tsx
- Leverage: constants/theme.ts
- Requirements: 8.1

## Instructions
- Implement ONLY task 45: "Create ErrorScreen component in components/common/ErrorScreen.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mobile-app-implementation 45 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mobile-app-implementation 45 --mode complete
```
