# mobile-app-fixes - Task 21

Execute task 21 for the mobile-app-fixes specification.

## Task Description
Implement empty state in news page
...
## Usage
```
/Task:21-mobile-app-fixes
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement empty state in news page"

```
Use the @spec-task-executor agent to implement task 21: "Implement empty state in news page" for the mobile-app-fixes specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: Implement empty state in news page
- Leverage: components/common/EmptyState.tsx (from task 17)
- Requirements: 5

## Instructions
- Implement ONLY task 21: "Implement empty state in news page"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mobile-app-fixes 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mobile-app-fixes 21 --mode complete
```
