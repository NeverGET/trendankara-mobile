# mobile-app-fixes - Task 17

Execute task 17 for the mobile-app-fixes specification.

## Task Description
Create EmptyState component

## Code Reuse
**Leverage existing code**: components/themed-text.tsx, @expo/vector-icons
...
## Usage
```
/Task:17-mobile-app-fixes
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create EmptyState component"

```
Use the @spec-task-executor agent to implement task 17: "Create EmptyState component" for the mobile-app-fixes specification and include all the below context.
...
- Leverage: components/themed-text.tsx, @expo/vector-icons
- Requirements: 5

## Instructions
- Implement ONLY task 17: "Create EmptyState component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mobile-app-fixes 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mobile-app-fixes 17 --mode complete
```
