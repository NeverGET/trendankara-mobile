# mobile-app-fixes - Task 20

Execute task 20 for the mobile-app-fixes specification.

## Task Description
Implement empty state in polls page
...
## Usage
```
/Task:20-mobile-app-fixes
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement empty state in polls page"

```
Use the @spec-task-executor agent to implement task 20: "Implement empty state in polls page" for the mobile-app-fixes specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Implement empty state in polls page
- Leverage: components/common/EmptyState.tsx (from task 17)
- Requirements: 5

## Instructions
- Implement ONLY task 20: "Implement empty state in polls page"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mobile-app-fixes 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mobile-app-fixes 20 --mode complete
```
