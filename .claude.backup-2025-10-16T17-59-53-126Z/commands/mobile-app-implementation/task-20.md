# mobile-app-implementation - Task 20

Execute task 20 for the mobile-app-implementation specification.

## Task Description
Add location and expiration handling to ContentCard.tsx
...
## Usage
```
/Task:20-mobile-app-implementation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add location and expiration handling to ContentCard.tsx"

```
Use the @spec-task-executor agent to implement task 20: "Add location and expiration handling to ContentCard.tsx" for the mobile-app-implementation specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Add location and expiration handling to ContentCard.tsx
- Requirements: 3.4, 3.5

## Instructions
- Implement ONLY task 20: "Add location and expiration handling to ContentCard.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mobile-app-implementation 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mobile-app-implementation 20 --mode complete
```
