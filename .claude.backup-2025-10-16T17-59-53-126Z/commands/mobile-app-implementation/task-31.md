# mobile-app-implementation - Task 31

Execute task 31 for the mobile-app-implementation specification.

## Task Description
Create NewsCard component in components/news/NewsCard.tsx

## Code Reuse
**Leverage existing code**: expo-image
...
## Usage
```
/Task:31-mobile-app-implementation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create NewsCard component in components/news/NewsCard.tsx"

```
Use the @spec-task-executor agent to implement task 31: "Create NewsCard component in components/news/NewsCard.tsx" for the mobile-app-implementation specification and include all the below context.
...
## Task Details
- Task ID: 31
- Description: Create NewsCard component in components/news/NewsCard.tsx
- Leverage: expo-image
- Requirements: 5.3, 5.8

## Instructions
- Implement ONLY task 31: "Create NewsCard component in components/news/NewsCard.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mobile-app-implementation 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mobile-app-implementation 31 --mode complete
```
