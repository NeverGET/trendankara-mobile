# app-icon-implementation - Task 37

Execute task 37 for the app-icon-implementation specification.

## Task Description
Add README with usage instructions

## Code Reuse
**Leverage existing code**: existing README.md patterns
...
## Usage
```
/Task:37-app-icon-implementation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add README with usage instructions"

```
Use the @spec-task-executor agent to implement task 37: "Add README with usage instructions" for the app-icon-implementation specification and include all the below context.
...
## Task Details
- Task ID: 37
- Description: Add README with usage instructions
- Leverage: existing README.md patterns
- Requirements: 4.4

## Instructions
- Implement ONLY task 37: "Add README with usage instructions"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks app-icon-implementation 37 --mode complete
...
```bash
claude-code-spec-workflow get-tasks app-icon-implementation 37 --mode complete
```
